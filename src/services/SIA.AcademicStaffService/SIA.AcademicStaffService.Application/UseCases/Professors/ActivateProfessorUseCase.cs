...
public sealed class ActivateProfessorUseCase
{
    private readonly IProfessorDataStore _dataStore;

    public ActivateProfessorUseCase(IProfessorDataStore dataStore)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var integrationEvent = new ProfessorActivatedIntegrationEvent
        {
