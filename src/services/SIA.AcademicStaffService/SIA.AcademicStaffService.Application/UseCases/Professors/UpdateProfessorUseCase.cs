...
public sealed class UpdateProfessorUseCase
{
    private readonly IProfessorDataStore _dataStore;

    public UpdateProfessorUseCase(IProfessorDataStore dataStore)
    {
        _dataStore = dataStore;
    }

    public async Task<UpdateProfessorResponse> ExecuteAsync(
        Guid tenantId,
        Guid professorId,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var integrationEvent = new ProfessorUpdatedIntegrationEvent
        {
