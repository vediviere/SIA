...
public sealed class FakeUserDataStore : IUserDataStore
{
  ...
  public bool UserAdded { get; private set; }
  ...
  public Task AddUserAsync(User user, UserCreatedIntegrationEvent userCreatedEvent, string auditAction, CancellationToken cancellationToken)
  {
    AddedUser = user;
    UserAdded = true;
    UserAuditAction = auditAction;
