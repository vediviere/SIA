...
public sealed class RestoreSupportActivityUseCase
{
    private readonly ISupportActivityDataStore _dataStore;

    public RestoreSupportActivityUseCase(ISupportActivityDataStore dataStore)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var integrationEvent = new SupportActivityRestoredIntegrationEvent
        {
