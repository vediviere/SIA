...
public sealed class ActivateAcademicOfferingUseCase
{
  ...
  public ActivateAcademicOfferingUseCase(IAcademicOfferingDataStore dataStore, IAcademicLoadDataStore academicLoadDataStore, AcademicLoadClassHoursCalculator classHoursCalculator, ProposalValidator proposalValidator)
  {
  ...
  public async Task ExecuteAsync(Guid tenantId, Guid id, Guid correlationId, CancellationToken cancellationToken)
  {
    ...
    await _dataStore.ActivateAcademicOfferingWithOutboxAsync(academicOffering, academicLoad, integrationEvent, cancellationToken);
  }
}
