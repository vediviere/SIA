namespace SIA.WorkflowService.Infrastructure.Persistence.Entities;
...
public sealed class InboxMessage
{
  ...
  public InboxMessage(Guid id, string eventType, string sourceService, Guid correlationId)
  {
    if (id == Guid.Empty)
    {
    ...
    {
      throw new ArgumentException("El servicio de origen es obligatorio.", nameof(sourceService));
    }
