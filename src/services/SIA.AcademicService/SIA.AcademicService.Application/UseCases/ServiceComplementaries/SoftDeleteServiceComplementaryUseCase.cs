...
public sealed class SoftDeleteServiceComplementaryUseCase
{
    private readonly IServiceComplementaryDataStore _dataStore;

    public SoftDeleteServiceComplementaryUseCase(IServiceComplementaryDataStore dataStore)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var integrationEvent = new ServiceComplementaryDeletedIntegrationEvent
        {
        ...
        await _dataStore.SoftDeleteServiceComplementaryWithOutboxAsync(serviceComplementary, integrationEvent, cancellationToken);
    }
}