...
public sealed class UpdateAcademicPeriodUseCase
{
  private readonly IAcademicPeriodsDataStore _dataStore;

  public UpdateAcademicPeriodUseCase(IAcademicPeriodsDataStore dataStore)
  {
    _dataStore = dataStore;
  }
  public async Task<UpdateAcademicPeriodResponse> ExecuteAsync(Guid tenantId, Guid id, UpdateAcademicPeriodRequest request, Guid correlationId, CancellationToken cancellationToken)

  {
    ...
    var integrationEvent =
        new AcademicPeriodUpdatedIntegrationEvent
        {
