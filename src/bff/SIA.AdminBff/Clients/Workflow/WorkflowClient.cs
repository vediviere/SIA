...
public sealed class WorkflowClient : IWorkflowClient
{
    ...
    public async Task<IEnumerable<ReviewProcessListItemDto>> GetPendingReviewsAsync(CancellationToken cancellationToken)
    {
    ...
    public async Task<ReviewProcessDetailDto?> GetReviewByIdAsync(Guid processId, CancellationToken cancellationToken)
    {
    ...
    public async Task ApproveReviewAsync(Guid processId, CancellationToken cancellationToken)
    {
    ...
    public async Task ReturnReviewAsync(Guid processId, ReturnRequestDto requestDto, CancellationToken cancellationToken)
    {
